...
def test_read_orders_superuser(client: TestClient, db: Collection, superuser_token_headers) -> None:
    for i in range(3):
...
def test_read_orders_normal_user(client: TestClient, db: Collection, normal_user_token_headers) -> None:
...
def test_read_order_superuser(client: TestClient, db: Collection, superuser_token_headers) -> None:
...
def test_read_order_normal_user(client: TestClient, db: Collection, normal_user_token_headers) -> None:
    existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
    id = existing_order["_id"]
...
def test_read_order_wrong_user(client: TestClient, db: Collection, normal_user_token_headers) -> None:
...
# def test_read_order_products_superuser(client: TestClient, db: Collection, superuser_token_headers) -> None:
#     existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
#     id = existing_order["_id"]
...
def test_order_by_status_superuser(client: TestClient, db: Collection, superuser_token_headers) -> None:
    for i in range(3):
        obj_in = {"user_id": i, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"}
        crud.create(db=db, obj_in=obj_in)
...
def test_order_by_status_normal_user(client: TestClient, db: Collection, normal_user_token_headers) -> None:
    existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
    response = client.get(f"/orders/status/pending", headers=normal_user_token_headers)
    assert response.status_code == 401
    
    
def test_create_order(client: TestClient, db: Collection, normal_user_token_headers) -> None:
...
def test_update_order_normal_user(client: TestClient, db: Collection, normal_user_token_headers) -> None:
    existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
    id = existing_order["_id"]
    data = {"status": "shipped"}
...
def test_update_order_superuser(client: TestClient, db: Collection, superuser_token_headers) -> None:
    existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
    id = existing_order["_id"]
    data = {"status": "shipped"}
...
def test_delete_order(client: TestClient, db: Collection, normal_user_token_headers) -> None:
    existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
    id = existing_order["_id"]
...
def test_delete_order_superuser(client: TestClient, db: Collection, superuser_token_headers) -> None:
    existing_order = crud.create(db=db, obj_in={"user_id": 2, "status": "pending", "shoppingcart_id": "65c8dd402a24d2c9d160d17f", "address": "123 Main St", "phone": "123-456-7890"})
    id = existing_order["_id"]
